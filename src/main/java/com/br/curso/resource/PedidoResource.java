...
public class PedidoResource {
	...
	@GetMapping()
	public ResponseEntity<Page<Pedido>> listarPaginacao(@RequestParam(name = "page", defaultValue = "0") Integer page,
			@RequestParam(name = "linesPerPage", defaultValue = "24") Integer linesPerPage,
			@RequestParam(name = "orderBy", defaultValue = "instante") String orderBy,
			@RequestParam(name = "direction", defaultValue = "DESC") String direction) {
		Page<Pedido> listaPedidos = service.listarPaginacao(page, linesPerPage, orderBy, direction);
